...
async def _(event):
    ...
    me = borg.me
    userid = borg.uid
    packname = "Kanishk's kang Pack"
    packshortname = "Kanishk_stickers"
    ...
    await event.edit("Kanging sticker. Please wait.")
    ...
    await event.edit(f"Sticker kanged! Your kang pack can be found [here](t.me/addstickers/{packshortname})")
